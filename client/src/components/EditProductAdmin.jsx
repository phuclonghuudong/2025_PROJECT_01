...
const EditProductAdmin = ({ data: ProductData, close, fetchData }) => {
  ...
  return (
    <section className="fixed top-0 bottom-0 left-0 right-0 bg-neutral-800 bg-opacity-50 flex justify-center items-center">
      <div className="bg-white max-w-2xl w-full p-4 rounded  overflow-y-auto z-50 h-full max-h-[89vh] ">
        <div className="flex items-center justify-between shadow-lg p-2 sticky top-0 bg-white w-full">
        ...
        <section>
          <div className="grid p-3">
            <form className="grid gap-3" onSubmit={handleSubmitForm}>
              ...
              <button
                onClick={close}
                className="bg-blue-300 p-2 rounded hover:bg-blue-600 font-semibold hover:text-white"
              >
                Cancel
              </button>
            </form>
